...
class ServiceController extends Controller{
    ...
    public function details($id){
        ...
        return view('Template::user.service.details', compact('pageTitle', 'service', 'accountSummary', 'serverGroup', 'execute', 'cancelRequestTypes', 'diskUsagePercent', 'product', 'status', 'hasAccount', 'nameservers'));
    }
