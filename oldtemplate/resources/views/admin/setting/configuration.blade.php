            ...
            <form method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Auto Domain Register')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, domains will be registered automatically')</small>
                                </p>
                            </div>
                            <div class="form-group"> 
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="auto_domain_register" @if(gs('auto_domain_register')) checked @endif>
                            </div>
                        </li>

                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div> 
                                <p class="fw-bold mb-0">@lang('Deposit Module')</p>
                                <p class="mb-0">
                                    <small>@lang('If you disable this module, users cannot deposits on the system')</small>
                                </p>
                            </div>
                            <div class="form-group"> 
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="deposit_module" @if(gs('deposit_module')) checked @endif>
                            </div>
                        </li>
                    </ul>
                </div>
