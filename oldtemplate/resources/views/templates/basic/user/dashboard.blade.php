...
<div class="col-lg-9 space-y-6">
    ...
    <!-- Metrics Strip (Redesigned Compact Cards) -->
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        <!-- Active Services -->
        <a href="{{ route('user.service.list') }}" class="p-4 bg-[#141416] hover:bg-[#18181B] border border-white/10 hover:border-indigo-500/30 rounded-xl transition-all group flex flex-col justify-between space-y-3">
            <div class="flex items-center justify-between">
                ...
                <span class="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-indigo-500/10 text-indigo-300 border border-indigo-500/20">@lang('Live')</span>
            </div>
            <div>
                <div class="text-2xl font-bold text-white font-mono tracking-tight">{{ $widget['active_services'] ?? 0 }}</div>
                <div class="text-xs font-medium text-neutral-400 mt-0.5 flex items-center justify-between">
                    <span>@lang('Active Services')</span>
                    <i data-lucide="arrow-right" class="w-3.5 h-3.5 text-neutral-500 group-hover:text-indigo-400 group-hover:translate-x-0.5 transition-all"></i>
                </div>
            </div>
        </a>

        <!-- Active Domains -->
        <a href="{{ route('user.domain.list') }}" class="p-4 bg-[#141416] hover:bg-[#18181B] border border-white/10 hover:border-cyan-500/30 rounded-xl transition-all group flex flex-col justify-between space-y-3">
            <div class="flex items-center justify-between">
                <div class="w-9 h-9 rounded-lg bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 group-hover:scale-105 transition-transform">
                    <i data-lucide="globe" class="w-4 h-4"></i>
                </div>
                <span class="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-cyan-500/10 text-cyan-300 border border-cyan-500/20">@lang('DNS')</span>
            </div>
            <div>
                <div class="text-2xl font-bold text-white font-mono tracking-tight">{{ $widget['active_domains'] ?? 0 }}</div>
                <div class="text-xs font-medium text-neutral-400 mt-0.5 flex items-center justify-between">
                    <span>@lang('My Domains')</span>
                    <i data-lucide="arrow-right" class="w-3.5 h-3.5 text-neutral-500 group-hover:text-cyan-400 group-hover:translate-x-0.5 transition-all"></i>
                </div>
            </div>
        </a>

        <!-- Pending Invoices -->
        <a href="{{ route('user.invoice.list') }}" class="p-4 bg-[#141416] hover:bg-[#18181B] border border-white/10 hover:border-amber-500/30 rounded-xl transition-all group flex flex-col justify-between space-y-3">
            <div class="flex items-center justify-between">
                ...
                <span class="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-amber-500/10 text-amber-300 border border-amber-500/20">@lang('Billing')</span>
            </div>
            <div>
                <div class="text-2xl font-bold text-white font-mono tracking-tight">{{ $widget['unpaid_invoices'] ?? 0 }}</div>
                <div class="text-xs font-medium text-neutral-400 mt-0.5 flex items-center justify-between">
                    <span>@lang('Unpaid Invoices')</span>
                    <i data-lucide="arrow-right" class="w-3.5 h-3.5 text-neutral-500 group-hover:text-amber-400 group-hover:translate-x-0.5 transition-all"></i>
                </div>
            </div>
        </a>

        <!-- Support Tickets -->
        <a href="{{ route('ticket.index') }}" class="p-4 bg-[#141416] hover:bg-[#18181B] border border-white/10 hover:border-emerald-500/30 rounded-xl transition-all group flex flex-col justify-between space-y-3">
            <div class="flex items-center justify-between">
                ...
                <span class="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-500/10 text-emerald-300 border border-emerald-500/20">@lang('Support')</span>
            </div>
            <div>
                <div class="text-2xl font-bold text-white font-mono tracking-tight">{{ $widget['open_tickets'] ?? 0 }}</div>
                <div class="text-xs font-medium text-neutral-400 mt-0.5 flex items-center justify-between">
                    <span>@lang('Open Tickets')</span>
                    <i data-lucide="arrow-right" class="w-3.5 h-3.5 text-neutral-500 group-hover:text-emerald-400 group-hover:translate-x-0.5 transition-all"></i>
                </div>
            </div>
        </a>
    </div>
