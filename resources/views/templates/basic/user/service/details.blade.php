    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                @endif
                <a href="{{ route('user.service.list') }}" class="px-3 py-1.5 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 text-xs font-semibold rounded-lg transition-all text-slate-700 flex items-center gap-1.5 shadow-xs">
